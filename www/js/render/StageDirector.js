var StageDirector = (function (Sprites, Drawables, Paths, Animations) {
    ...
    StageDirector.prototype.animateFresh = function (x, y, imgPathName, numberOfFrames, loop, zIndex, alpha, rotation, scale) {
    ...
    StageDirector.prototype.moveFresh = function (x, y, imgName, endX, endY, speed, spacing, loop, callback, zIndex, alpha, rotation, scale) {
    ...
    StageDirector.prototype.moveFreshText = function (x, y, msg, size, fontFamily, color, endX, endY, speed, spacing, loop, callback, zIndex, alpha, rotation, maxLineLength, lineHeight) {
        var drawable = this.getDrawableText(x, y, zIndex, msg, size, fontFamily, color, rotation, alpha, maxLineLength, lineHeight);
        var path = this.getPath(x, y, endX, endY, speed, spacing, loop);
